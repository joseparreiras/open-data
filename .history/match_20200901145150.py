...
plot = plt.figure(figsize = (120,80))
field = plt.imread('img/field2.png')
plot1 = plot.add_subplot()
plot1.imshow(field, interpolation = 'none')
plot1.scatter(average_position[0].iloc[11:], average_position[1].iloc[11:])
plt.ylim(0, 80)
plt.xlim(0, 120)
plot.show()
