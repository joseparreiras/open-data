...
class match(object):
    ...
    def position_map(self, starting=True, plot=True):
        ...
        Returns:
            ...
            DataFrame: The average coordinate for each player
        """
    ...
    def pass_network(self):
        """Calculate the matrix of os passes between each pair of players
        """
    ...
    def touch_map(self, touch_type=None, plot=True):
        ...
        Returns:
            ...
            pandas.DataFrame: A Data Frame with every touch location
        """
