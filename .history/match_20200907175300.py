...
class match(object):
    ...
    def __init__(self, data, lineups, active_tactics=None):
        import pandas as pd
        import numpy as np
        ...
        if active_tactics == None:
            ...
            selc.active_tactics = active_tactics
        for team in self.teams:
            ...
            if len(starting_tactics) > 0:
                self.active_tactics.update({team: starting_tactics})
    ...
    def window(self, start, end=(100, 0)):
        ...
        return match(self.data.iloc[time_idx], self.lineups, self.active_tactics)
    ...
    def space(self, lat_range=(0, 120), lon_range=(0, 80)):
        ...
        return match(self.data.iloc[loc_idx], self.lineups, self.active_tactics)
    ...
    def team_match(self, team_name):
        ...
        return match(self.data.iloc[team_idx], self.lineups, self.active_tactics)
    ...
    def player_match(self, player_name):
        ...
        return player_match(not_null_player.iloc[player_idx], self.lineups, self.active_tactics)
