...
class match(object):
    ...
    def summary(self):
        ...
        for team in self.teams:
            ...
            yellow_cards_foul = [x for x in team_match.data.foul_committed.dropna() if 'card' in x.keys() and x['card']['name'] in ['Yellow Card', 'Second Yellow']]
            yellow_card_beh = [x for x in team_match.data.bad_behaviour.dropna() if 'card' in x.keys() and x['card']['name'] in ['Yellow Card', 'Second Yellow']]
            yellow_card = yellow_card_foul+yellow_card_beh
            ...
            red_card_beh = [x for x in team_match.data.bad_behaviour.dropna() if 'card' in x.keys() and x['card']['name'] in ['Red Card', 'Second Yellow']]
            red_card = red_card_foul+red_card_beh


            foul_summary = {'fouls': len(foul_idx),
