...
dim = field.shape[:2]
map = plt.subplot()
map.imshow(field, interpolation = 'none')
map.scatter(average_position[0].iloc[11:]/80*dim[0], average_position[1].iloc[11:]/120*dim[1], c = 'purple', s = 50)
map.spines['right'].set_visible(False)
map.spines['left'].set_visible(False)
map.show()